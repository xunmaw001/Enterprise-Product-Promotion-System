<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="分享链接" prop="fenxianglianjie">
          <el-input v-model="ruleForm.fenxianglianjie" 
              placeholder="分享链接" clearable  :readonly="ro.fenxianglianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="分享链接" prop="fenxianglianjie">
              <el-input v-model="ruleForm.fenxianglianjie" 
                placeholder="分享链接" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fenxiangshijian" label="分享时间" prop="fenxiangshijian">
              <el-input v-model="ruleForm.fenxiangshijian" 
                placeholder="分享时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="内容描述" prop="neirongmiaoshu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.neirongmiaoshu" label="内容描述" prop="neirongmiaoshu">
                    <span v-html="ruleForm.neirongmiaoshu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.neirongmiaoshu = true;
          ...
          if(o=='fenxianglianjie'){
            this.ruleForm.fenxianglianjie = obj[o];
	    this.ro.fenxianglianjie = true;
            continue;
          }
	...
	this.ruleForm.neirongmiaoshu = this.ruleForm.neirongmiaoshu.replace(reg,'../../../php5010m/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `taolun/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.taolunCrossAddOrUpdateFlag = false;
						 this.parent.search();
