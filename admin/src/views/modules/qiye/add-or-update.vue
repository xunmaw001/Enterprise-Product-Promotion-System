<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="邮箱地址" prop="youxiangdizhi">
          <el-input v-model="ruleForm.youxiangdizhi" 
              placeholder="邮箱地址" clearable  :readonly="ro.youxiangdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="邮箱地址" prop="youxiangdizhi">
              <el-input v-model="ruleForm.youxiangdizhi" 
                placeholder="邮箱地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='youxiangdizhi'){
            this.ruleForm.youxiangdizhi = obj[o];
	    this.ro.youxiangdizhi = true;
            continue;
          }
          if(o=='qiyedizhi'){
	...
	this.ruleForm.qiyejianjie = this.ruleForm.qiyejianjie.replace(reg,'../../../php5010m/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
